...
func TestDeleteExecution(t *testing.T) {
	...
	executionQuery := GlobalMock.NewMock().WithQuery(`DELETE FROM "executions" WHERE ("executions"."execution_project","executions"."execution_domain","executions"."execution_name") IN (($1,$2,$3))`)
