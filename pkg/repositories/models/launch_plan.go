...
type LaunchPlanKey struct {
	Project string `gorm:"uniqueIndex:primary_lp_index;index:lp_project_domain_name_idx,lp_project_domain_idx" valid:"length(0|255)"`
	Domain  string `gorm:"uniqueIndex:primary_lp_index;index:lp_project_domain_name_idx,lp_project_domain_idx" valid:"length(0|255)"`
	Name    string `gorm:"uniqueIndex:primary_lp_index;index:lp_project_domain_name_idx" valid:"length(0|255)"`
	Version string `gorm:"uniqueIndex:primary_lp_index" valid:"length(0|255)"`
}
