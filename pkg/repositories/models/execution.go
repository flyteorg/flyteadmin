...
type ExecutionKey struct {
	Project string `gorm:"primary_key;column:execution_project" valid:"length(1|255)"`
	Domain  string `gorm:"primary_key;column:execution_domain" valid:"length(1|255)"`
	Name    string `gorm:"primary_key;column:execution_name" valid:"length(1|255)"`
}
...
type Execution struct {
	...
	Phase        string `valid:"length(1|255)"`
	Closure      []byte
