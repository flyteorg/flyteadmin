...
type NamedEntityMetadataKey struct {
	ResourceType core.ResourceType `gorm:"primary_key;index:named_entity_metadata_type_project_domain_name_idx" valid:"length(1|50)"`
	Project      string            `gorm:"primary_key;index:named_entity_metadata_type_project_domain_name_idx" valid:"length(1|50)"`
	Domain       string            `gorm:"primary_key;index:named_entity_metadata_type_project_domain_name_idx" valid:"length(1|50)"`
	Name         string            `gorm:"primary_key;index:named_entity_metadata_type_project_domain_name_idx" valid:"length(1|50)"`
}
...
type NamedEntityKey struct {
	...
	Project      string `valid:"length(1|50)"`
	Domain       string `valid:"length(1|50)"`
	Name         string `valid:"length(1|50)"`
}
