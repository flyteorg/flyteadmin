...
type Resource struct {
	...
	Project      string     `gorm:"size:64;uniqueIndex:resource_idx" valid:"length(0|255)"`
	Domain       string     `gorm:"size:255;uniqueIndex:resource_idx" valid:"length(0|255)"`
	Workflow     string     `gorm:"size:255;uniqueIndex:resource_idx" valid:"length(0|255)"`
	LaunchPlan   string     `gorm:"size:255;uniqueIndex:resource_idx" valid:"length(0|255)"`
	ResourceType string     `gorm:"size:255;uniqueIndex:resource_idx" valid:"length(0|255)"`
