...
type UpdateProjectFunction func(ctx context.Context, updatedProject models.Project) (error)
...
func (r *MockProjectRepo) UpdateProject(ctx context.Context, updatedProject models.Project) (error) {
	if r.UpdateProjectFunction != nil {
		return r.UpdateProjectFunction(ctx, updatedProject)
	}
	return nil
}
