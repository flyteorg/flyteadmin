...
func UpdateTaskExecutionModel(request *admin.TaskExecutionEventRequest, taskExecutionModel *models.TaskExecution) error {
	...
	if (existingTaskPhase == core.TaskExecution_QUEUED || existingTaskPhase == core.TaskExecution_UNKNOWN) && taskExecutionModel.Phase == core.TaskExecution_RUNNING {
		err = addTaskStartedState(request, taskExecution, taskExecutionClosure)
		if err != nil {
			return nil, err
		}
	}
