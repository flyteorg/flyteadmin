...
func (cfg ServerConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "security.auth.appAuth.selfAuthServer.tokenHashKeySecretName"), defaultServerConfig.Security.Auth.AppAuth.SelfAuthServer.ClaimSymmetricEncryptionKeySecretName, "OPTIONAL")
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "security.auth.appAuth.externalAuthServer.expectedIssuer"), defaultServerConfig.Security.Auth.AppAuth.ExternalAuthServer.ExpectedAudience, "Expected Audience to use to validate access tokens.")
