...
func (cfg ServerConfig) GetPFlagSet(prefix string) *pflag.FlagSet {
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "security.auth.userAuth.openId.clientSecretFile"), defaultServerConfig.Security.Auth.UserAuth.OpenID.ClientSecretFile, "")
	...
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "security.auth.appAuth.issuer.issuer"), defaultServerConfig.Security.Auth.AppAuth.Issuer.Issuer, "")
	cmdFlags.String(fmt.Sprintf("%v%v", prefix, "security.auth.appAuth.issuer.accessTokenLifespan"), defaultServerConfig.Security.Auth.AppAuth.Issuer.AccessTokenLifespan.String(), "")
