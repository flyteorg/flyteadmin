...
var descriptionEntity = &admin.DescriptionEntity{ShortDescription: "hello"}
...
var compiledDescriptionEntityDigest = []byte{0x82, 0x62, 0xeb, 0x5, 0x98, 0xd, 0x52, 0x23, 0x25, 0x39, 0x91, 0x73, 0x95, 0xa2, 0x3f, 0xd5, 0x7b, 0x38, 0xed, 0x67, 0x8b, 0xfa, 0x55, 0x1f, 0xe6, 0x6, 0xb7, 0x58, 0x7c, 0xd3, 0x5b, 0xe4}
...
func TestGetDescriptionEntityDigest(t *testing.T) {
...
func TestGetDescriptionEntityDigest_Unequal(t *testing.T) {
	descriptionEntity = &admin.DescriptionEntity{ShortDescription: "test"}
	changedDescriptionEntityDigest, err := GetDescriptionEntityDigest(context.Background(), descriptionEntity)
	assert.Nil(t, err)
	assert.NotEqual(t, compiledTaskDigest, changedDescriptionEntityDigest)
}
