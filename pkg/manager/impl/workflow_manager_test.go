...
func TestCreateWorkflow(t *testing.T) {
	...
	repository.WorkflowRepo().(*repositoryMocks.MockWorkflowRepo).SetCreateCallback(func(input models.Workflow) error {
		assert.Equal(t, []byte{0xe0, 0xd6, 0x96, 0xe3, 0xd0, 0x77, 0x28, 0xe2, 0xf0, 0x78, 0x11, 0x15, 0x42, 0xb, 0x50, 0x91, 0x17, 0xf7, 0x45, 0x86, 0xf5, 0xb2, 0x2a, 0x96, 0xb5, 0x6b, 0xef, 0x7e, 0xb1, 0x75, 0xdb, 0x48}, input.Digest)
		createCalled = true
		return nil
	})
