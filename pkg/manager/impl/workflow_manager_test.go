...
func TestCreateWorkflow(t *testing.T) {
	...
	repository.WorkflowRepo().(*repositoryMocks.MockWorkflowRepo).SetCreateCallback(func(input models.Workflow) error {
		assert.Equal(t, []byte{0xf4, 0x53, 0xe3, 0xd, 0x18, 0xfe, 0x56, 0xf4, 0xed, 0x4e, 0xd5, 0xb6, 0x83, 0xfd, 0xfe, 0x8f, 0xb6, 0x67, 0x67, 0x85, 0x7b, 0xe1, 0x3e, 0xad, 0x4, 0x77, 0x1e, 0x97, 0x22, 0x86, 0x97, 0x19}, input.Digest)
		createCalled = true
		return nil
	})
