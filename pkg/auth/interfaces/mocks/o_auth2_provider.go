...
func (_m *OAuth2Provider) OnNewJWTSessionToken(subject string, userInfoClaims interface{}, appID string, issuer string, audience string) *OAuth2Provider_NewJWTSessionToken {
	c := _m.On("NewJWTSessionToken", subject, userInfoClaims, appID, issuer, audience)
...
// NewJWTSessionToken provides a mock function with given fields: subject, userInfoClaims, appID, issuer, audience
func (_m *OAuth2Provider) NewJWTSessionToken(subject string, userInfoClaims interface{}, appID string, issuer string, audience string) *oauth2.JWTSession {
	ret := _m.Called(subject, userInfoClaims, appID, issuer, audience)

	var r0 *oauth2.JWTSession
	if rf, ok := ret.Get(0).(func(string, interface{}, string, string, string) *oauth2.JWTSession); ok {
		r0 = rf(subject, userInfoClaims, appID, issuer, audience)
	} else {
		if ret.Get(0) != nil {
...
type OAuth2Provider_PublicKeys struct {
	*mock.Call
}

func (_m OAuth2Provider_PublicKeys) Return(_a0 []rsa.PublicKey) *OAuth2Provider_PublicKeys {
	return &OAuth2Provider_PublicKeys{Call: _m.Call.Return(_a0)}
}

func (_m *OAuth2Provider) OnPublicKeys() *OAuth2Provider_PublicKeys {
	c := _m.On("PublicKeys")
	return &OAuth2Provider_PublicKeys{Call: c}
}

func (_m *OAuth2Provider) OnPublicKeysMatch(matchers ...interface{}) *OAuth2Provider_PublicKeys {
	c := _m.On("PublicKeys", matchers...)
	return &OAuth2Provider_PublicKeys{Call: c}
}

// PublicKeys provides a mock function with given fields:
func (_m *OAuth2Provider) PublicKeys() []rsa.PublicKey {
	ret := _m.Called()
...
func (_m *OAuth2Provider) OnValidateAccessToken(ctx context.Context, tokenStr string) *OAuth2Provider_ValidateAccessToken {
...
func (_m *OAuth2Provider) ValidateAccessToken(ctx context.Context, tokenStr string) (interfaces.IdentityContext, error) {
