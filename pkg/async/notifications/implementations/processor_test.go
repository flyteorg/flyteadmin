...
func TestProcessor_StartProcessing(t *testing.T) {
	...
	assert.Nil(t, testProcessor.(*Processor).run(ctx))
}
...
func TestProcessor_StartProcessingError(t *testing.T) {
	...
	ctx := context.Background()
	assert.Equal(t, ret, testProcessor.(*Processor).run(ctx))
}
...
func TestProcessor_StopProcessing(t *testing.T) {
	initializeProcessor()
	ctx := context.Background()
	assert.Nil(t, testProcessor.StopProcessing(ctx))
}
...
func TestProcessor_StopProcessingError(t *testing.T) {
	...
	ctx := context.Background()
	assert.Equal(t, stopError, testProcessor.StopProcessing(ctx))
}
