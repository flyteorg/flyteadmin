...
func (WorkflowMetadata_OnFailurePolicy) EnumDescriptor() ([]byte, []int) {
	return file_flyteidl_core_workflow_proto_rawDescGZIP(), []int{8, 0}
}
...
var file_flyteidl_core_workflow_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x65, 0x6e, 0x63, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x0c, 0x4e, 0x6f, 0x64, 0x65, 0x4d,
	...
	0x12, 0x36, 0x0a, 0x07, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x07, 0x72, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x12, 0x26, 0x0a, 0x0d, 0x69, 0x6e, 0x74, 0x65,
	0x72, 0x72, 0x75, 0x70, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x48,
	...
	0x09, 0x52, 0x05, 0x61, 0x6c, 0x69, 0x61, 0x73, 0x22, 0xac, 0x03, 0x0a, 0x04, 0x4e, 0x6f, 0x64,
	...
	0x00, 0x52, 0x0a, 0x62, 0x72, 0x61, 0x6e, 0x63, 0x68, 0x4e, 0x6f, 0x64, 0x65, 0x42, 0x08, 0x0a,
	0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x22, 0x84, 0x02, 0x0a, 0x10, 0x57, 0x6f, 0x72, 0x6b,
	...
	0x52, 0x09, 0x6f, 0x6e, 0x46, 0x61, 0x69, 0x6c, 0x75, 0x72, 0x65, 0x22, 0x51, 0x0a, 0x0f, 0x4f,
	...
	0x61, 0x75, 0x6c, 0x74, 0x73, 0x22, 0x4b, 0x0a, 0x11, 0x54, 0x61, 0x73, 0x6b, 0x4e, 0x6f, 0x64,
	...
	0x65, 0x73, 0x42, 0xad, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x6c, 0x79, 0x74, 0x65,
	0x69, 0x64, 0x6c, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x42, 0x0d, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c,
	0x6f, 0x77, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x34, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_flyteidl_core_workflow_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_flyteidl_core_workflow_proto_goTypes = []interface{}{
	...
	(*NodeMetadata)(nil),                  // 6: flyteidl.core.NodeMetadata
	(*Alias)(nil),                         // 7: flyteidl.core.Alias
	(*Node)(nil),                          // 8: flyteidl.core.Node
	(*WorkflowMetadata)(nil),              // 9: flyteidl.core.WorkflowMetadata
	(*WorkflowMetadataDefaults)(nil),      // 10: flyteidl.core.WorkflowMetadataDefaults
	(*WorkflowTemplate)(nil),              // 11: flyteidl.core.WorkflowTemplate
	(*TaskNodeOverrides)(nil),             // 12: flyteidl.core.TaskNodeOverrides
	(*BooleanExpression)(nil),             // 13: flyteidl.core.BooleanExpression
	(*Error)(nil),                         // 14: flyteidl.core.Error
	(*Identifier)(nil),                    // 15: flyteidl.core.Identifier
	(*durationpb.Duration)(nil),           // 16: google.protobuf.Duration
	(*RetryStrategy)(nil),                 // 17: flyteidl.core.RetryStrategy
	(*Binding)(nil),                       // 18: flyteidl.core.Binding
	(*QualityOfService)(nil),              // 19: flyteidl.core.QualityOfService
	(*TypedInterface)(nil),                // 20: flyteidl.core.TypedInterface
	(*Resources)(nil),                     // 21: flyteidl.core.Resources
}
var file_flyteidl_core_workflow_proto_depIdxs = []int32{
	13, // 0: flyteidl.core.IfBlock.condition:type_name -> flyteidl.core.BooleanExpression
	8,  // 1: flyteidl.core.IfBlock.then_node:type_name -> flyteidl.core.Node
	...
	8,  // 4: flyteidl.core.IfElseBlock.else_node:type_name -> flyteidl.core.Node
	14, // 5: flyteidl.core.IfElseBlock.error:type_name -> flyteidl.core.Error
	2,  // 6: flyteidl.core.BranchNode.if_else:type_name -> flyteidl.core.IfElseBlock
	15, // 7: flyteidl.core.TaskNode.reference_id:type_name -> flyteidl.core.Identifier
	12, // 8: flyteidl.core.TaskNode.overrides:type_name -> flyteidl.core.TaskNodeOverrides
	15, // 9: flyteidl.core.WorkflowNode.launchplan_ref:type_name -> flyteidl.core.Identifier
	15, // 10: flyteidl.core.WorkflowNode.sub_workflow_ref:type_name -> flyteidl.core.Identifier
	16, // 11: flyteidl.core.NodeMetadata.timeout:type_name -> google.protobuf.Duration
	17, // 12: flyteidl.core.NodeMetadata.retries:type_name -> flyteidl.core.RetryStrategy
	6,  // 13: flyteidl.core.Node.metadata:type_name -> flyteidl.core.NodeMetadata
	18, // 14: flyteidl.core.Node.inputs:type_name -> flyteidl.core.Binding
	7,  // 15: flyteidl.core.Node.output_aliases:type_name -> flyteidl.core.Alias
	4,  // 16: flyteidl.core.Node.task_node:type_name -> flyteidl.core.TaskNode
	5,  // 17: flyteidl.core.Node.workflow_node:type_name -> flyteidl.core.WorkflowNode
	3,  // 18: flyteidl.core.Node.branch_node:type_name -> flyteidl.core.BranchNode
	19, // 19: flyteidl.core.WorkflowMetadata.quality_of_service:type_name -> flyteidl.core.QualityOfService
	0,  // 20: flyteidl.core.WorkflowMetadata.on_failure:type_name -> flyteidl.core.WorkflowMetadata.OnFailurePolicy
	15, // 21: flyteidl.core.WorkflowTemplate.id:type_name -> flyteidl.core.Identifier
	9,  // 22: flyteidl.core.WorkflowTemplate.metadata:type_name -> flyteidl.core.WorkflowMetadata
	20, // 23: flyteidl.core.WorkflowTemplate.interface:type_name -> flyteidl.core.TypedInterface
	8,  // 24: flyteidl.core.WorkflowTemplate.nodes:type_name -> flyteidl.core.Node
	18, // 25: flyteidl.core.WorkflowTemplate.outputs:type_name -> flyteidl.core.Binding
	8,  // 26: flyteidl.core.WorkflowTemplate.failure_node:type_name -> flyteidl.core.Node
	10, // 27: flyteidl.core.WorkflowTemplate.metadata_defaults:type_name -> flyteidl.core.WorkflowMetadataDefaults
	21, // 28: flyteidl.core.TaskNodeOverrides.resources:type_name -> flyteidl.core.Resources
...
func file_flyteidl_core_workflow_proto_init() {
	...
	file_flyteidl_core_workflow_proto_msgTypes[7].OneofWrappers = []interface{}{
		(*Node_TaskNode)(nil),
